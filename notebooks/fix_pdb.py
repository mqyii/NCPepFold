...
if __name__ == "__main__":
    root_path = Path('/home/light/mqy/ncaa/data/ncaa/cyc/monomer/head_to_tail/4M6E')
    name = root_path.name
    clean_pdb = root_path / f"{name}_clean.pdb"
    predict_pdb = root_path / f"predict_{name}.pdb"
    output_path = root_path
    fix(name, clean_pdb, predict_pdb, output_path)
