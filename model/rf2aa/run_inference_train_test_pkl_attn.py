...
from rf2aa.data_loader_train import data_loader, load_samples, my_collate_fn
...
class ModelRunner:
    ...
    def load_model(self):
        ...
        checkpoint = torch.load("/home/light/mqy/ncaa/notebooks/tmp/ckpt/rfaa_20241105101418_1e-05_192.pt", map_location=self.device)       
        self.model.load_state_dict(checkpoint)
        self.transformer_model = Transformer().to(self.device)
        checkpoint_attn = torch.load("/home/light/mqy/ncaa/notebooks/tmp/ckpt/attn_20241105101418_0.0001_192.pt", map_location=self.device)
    ...
    def finetuning_infer_plus(self):
        ...
        for epoch in range(192,500):
            ...
            with open(f'/home/light/mqy/ncaa/notebooks/tmp/loss_txt/FAPEloss_20241105101418_training.txt', 'a') as f: #👿改
                f.write(each_epoch_info + '\n')
            ...
            with torch.no_grad():
                ...
                with open(f'/home/light/mqy/ncaa/notebooks/tmp/loss_txt/FAPEloss_20241105101418_test.txt', 'a') as f: #👿改
                    f.write(each_epoch_info_test + '\n')
            torch.cuda.empty_cache()
