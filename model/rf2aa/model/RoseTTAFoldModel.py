...
class RoseTTAFoldModule(nn.Module):
    def __init__(
        ...
        self.latent_emb = MSA_emb(
            ...
            enable_same_chain=enable_same_chain, nc_cycle = self.nc_cycle, seq_len = self.seq_len
        )
    ...
    def forward(
        ...
        # print(f"attn_feats: {attn_feats.shape}")
        # exit()
        if attn_feats is not None:
            print("attn_feats is not None")
            pair = pair + attn_feats
