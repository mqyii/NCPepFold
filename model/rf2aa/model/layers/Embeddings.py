...
class MSA_emb(nn.Module):
    ...
    def __init__(self, d_msa=256, d_pair=128, d_state=32, d_init=0,
                 minpos=-32, maxpos=32, maxpos_atom=8, p_drop=0.1, use_same_chain=False, enable_same_chain=False, nc_cycle = False, seq_len = False):
        if (d_init==0):
        ...
        self.pos = PositionalEncoding2D(d_pair, minpos=minpos, maxpos=maxpos, 
                                        ...
                                        enable_same_chain=enable_same_chain, nc_cycle = nc_cycle, seq_len = seq_len)
