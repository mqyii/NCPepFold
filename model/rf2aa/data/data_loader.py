...
class RawInputData:
    ...
    def update_protein_features_after_atomize(self, residues_to_atomize):
        ...
        chain_bins = self.get_chain_bins_from_chain_lengths()  # chain_bins = 165
        # print("chain_bins")
        # print("aaaaaa",self.chain_lengths) # [('A', 11), ('B', 138), ('C', 7), ('D', 11)]
        # print(chain_bins) # {'A': (0, 11), 'B': (11, 149), 'C': (149, 156), 'D': (156, 167)}
        ...
        for residue in residues_to_atomize:
            ...
            # print("residue", residue)  # 坏掉
            # print(Ls_from_same_chain_2d(same_chain_from_bond_feats(self.bond_feats)))
            #####
            # >>> residue AtomizedResidue(chain='C', chain_index_in_combined_chain=None, absolute_N_index_in_chain=0, absolute_C_index_in_chain=2, original_chain='A', index_in_original_chain=1)
            # >>> [156, 11]
            # >>> residue AtomizedResidue(chain='D', chain_index_in_combined_chain=None, absolute_N_index_in_chain=0, absolute_C_index_in_chain=2, original_chain='A', index_in_original_chain=8)
            # >>> [167]
    ...
    def keep_features(self, keep):
        ...
        self.bond_feats = self.bond_feats[keep][:,keep]  # 减去两个原子🌈 在此步骤之前就已经和在一起
    ...
    #     # 🌈
    #     config_pro = ConfigPro.load_config()
    #     print(config_pro)
    #     exit()
