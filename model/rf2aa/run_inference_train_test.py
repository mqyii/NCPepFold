...
class ModelRunner:
    ...
    def load_model(self):
        ...
        checkpoint = torch.load("/home/light/mqy/ncaa/notebooks/tmp/ckpt/rfaa_20241016100658_12.pt", map_location=self.device)
    ...
    def finetuning_infer(self):
        ...
        # with open(f'/home/light/mqy/ncaa/notebooks/tmp/loss_txt/FAPEloss_{runner_version}_nc_mono.txt', 'a') as f:
        ...
        loader = data_loader('/home/light/mqy/ncaa/notebooks/tmp/nc_mono.txt', batch_size=1)
        loader_test = data_loader('/home/light/mqy/ncaa/notebooks/tmp/nc_mono_test.txt', batch_size=1)
        ...
        for epoch in range(12,100):
            ...
            with torch.no_grad():
                ...
                with open(f'/home/light/mqy/ncaa/notebooks/tmp/loss_txt/FAPEloss_{runner_version}_nc_mono_test.txt', 'a') as f:
